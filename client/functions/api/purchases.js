...
export async function onRequestPost({ request, env }) {
  ...
  const { id, farmerName, productName, qtyKg, rate, total, date, paymentMode } = body;
  ...
  try {
    ...
    await env.DB.prepare(`
      INSERT INTO purchases (id, farmerName, productName, qtyKg, rate, total, date, paymentMode)
